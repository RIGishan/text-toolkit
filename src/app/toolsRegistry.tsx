...
export const toolsRegistry: ToolConfig[] = [
  ...
  description: "Normalize line endings and whitespace safely (CRLF/LF, trim, remove trailing spaces, collapse blanks).",
  ...
  description: "Generate JSON-LD schema for common templates (Article, FAQ, HowTo, Product, LocalBusiness).",
